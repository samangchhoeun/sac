...
Public Class rptPatientRegCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCENTER.rptPatientRegCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPatientRegCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatientRegCard = New rptPatientRegCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
