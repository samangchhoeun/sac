...
Public Class frmGroupPermissions
    ...
    Public Sub LoadGroupPermission(FindID As String)
        Dim dt As DataTable = GetDataFromDBToTable("SA_GetGroupPermissionToList", New SqlParameter("@id", FindID))
        If dt.Rows.Count > 0 Then
            With gvGroups
                gcGroups.DataSource = dt
                .PopulateColumns()
