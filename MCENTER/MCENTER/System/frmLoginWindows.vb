...
Public Class frmLoginWindows
    ...
    Private Sub frmLoginWindows_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Opacity = 0        GetDataToComboBoxWithParam(lueLanguage, "SA_GetNationalityList", "ID", "Nationality")        
        CheckIfRunning()

        'Change Windowws Theme
    ...
    Private Sub picLogo_Click(sender As Object, e As EventArgs) Handles picLogo.Click
        ...
        End If
        'If Width = 802 Then
        '    btnShow.Image = ilButtonList.Images(0)
        'Else
        '    btnShow.Image = ilButtonList.Images(1)
        'End If
        txtUserID.Focus()
    End Sub
    ...
    Private Sub lblDateTime_Click(sender As Object, e As EventArgs) Handles lblDateTime.Click, LabelControl1.Click
        LoadFormDialog(frmNewMessageAlert)
    End Sub

    Private Sub bbiShow_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiShow.ItemClick
        If Width = 280 Then
            Width += 525
            bbiShow.Caption = "Hide"
        Else
            Width -= 525
